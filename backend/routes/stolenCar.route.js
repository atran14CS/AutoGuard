...
router.post('/addStolenCar', async (req, res) => {
...
router.get('/getStolenCars', async (req, res) => {
    try {
...
router.get('/getStolenCar/:licensePlate', async (req, res) => {
...
router.get('/getComments/:licensePlate', async (req, res) => {
    let licensePlate = req.params.licensePlate;
    try {
